...
### [5] [Tensor resonances in teleparallel Gauss-Bonnet branes](https://arxiv.org/abs/2607.20567)
...
### [6] [Moduli-Space Laplacians, Asymptotic Geometry, and the Emergent String Conjecture](https://arxiv.org/abs/2607.20603)
...
### [7] [Towards Generalized Dimers for GTPs: $\mathcal{N}=2$ Fractional Branes at Infinite Coupling](https://arxiv.org/abs/2607.20607)
...
### [8] [New Type IIB Poly-instanton Effects and Axion Quintessence](https://arxiv.org/abs/2607.20613)
...
### [9] [Sp(4,Z) actions on 3d U(1)^2 symmetric theories: Order-five duality and bilayer quantum Hall hierarchies](https://arxiv.org/abs/2607.20622)
...
### [11] [Uniqueness of null-local modular flow](https://arxiv.org/abs/2607.20678)
...
### [12] [Flux Vacua Near the Boundary of Large Complex Structure](https://arxiv.org/abs/2607.20777)
...
### [13] [Quantum Mpemba effect in holography](https://arxiv.org/abs/2607.20899)
...
### [14] [Coherent states versus Glauber-Sudarshan States: Bootstrapping, Schwinger-Keldysh Contours and Lefschetz Thimbles](https://arxiv.org/abs/2607.20927)
...
### [15] [Boundary Completion of Vacuum Persistence Probability](https://arxiv.org/abs/2607.20936)
...
### [16] [3d-3d correspondence for knot complements with finite and large $N$](https://arxiv.org/abs/2607.21479)
*Hee-Joong Chung*
...
### [17] [Selecting Complex Extremal Surfaces with the Kontsevich--Segal--Witten Criterion](https://arxiv.org/abs/2607.21030)
*Wu-zhong Guo*
...
### [18] [Gauge-Theoretical Method in Solving Zero-curvature Equations III --Gauge Theoretical Method and the Bäcklund Transformations for Solitons--](https://arxiv.org/abs/2607.21052)
...
### [19] [One-point holographic correlator in the expanding universe](https://arxiv.org/abs/2607.21107)
...
### [20] [Carroll fermions of arbitrary spin](https://arxiv.org/abs/2607.21124)
...
### [21] [Energy-Energy Correlators at Strong Coupling](https://arxiv.org/abs/2607.21139)
...
### [22] [Defect entanglement entropy for superconformal RG Interfaces](https://arxiv.org/abs/2607.21270)
...
### [23] [Diagonally gauged anomaly-free 6D supergravities and their vacua](https://arxiv.org/abs/2607.21311)
...
### [24] [High-Order Pole-Skipping in Near-Extremal Holography](https://arxiv.org/abs/2607.21386)
...
### [25] [Wilson Towers as Local Bulk Fields](https://arxiv.org/abs/2607.21397)
...
### [26] [Relational path integral, effective actions and quantum frame covariance](https://arxiv.org/abs/2607.21463)
...
### [27] [A universal scaling function for giant graviton OPE coefficients](https://arxiv.org/abs/2607.21472)
...
### [28] [Aspects of Closed Matricial Worlds](https://arxiv.org/abs/2607.21509)
...
### [29] [Revealing the conformal symmetry of the discrete series scalars in dS${}_2$](https://arxiv.org/abs/2607.21514)
*Lukas W. Lindwasser*
...
### [30] [On the strong coupling limit of Yang-Mills matrix models](https://arxiv.org/abs/2607.21593)
...
### [31] [Lithium-Projected Phonon Spectral Distributions as Robust Descriptors of Ionic Conductivity in Solid Electrolytes](https://arxiv.org/abs/2607.20591)
...
### [33] [Magnetic ground states of CrPS$_4$ and NiPS$_3$ monolayers from long-range exchange interactions](https://arxiv.org/abs/2607.20631)
...
### [34] [A high-dimensional neural network potential for finite-temperature phenomena in NiTi martensite](https://arxiv.org/abs/2607.20681)
...
### [35] [Analytical Forces from the Bethe-Salpeter Equation for Large-Scale Excited-State Relaxation](https://arxiv.org/abs/2607.20728)
...
### [36] [First-principles calculation of electron-phonon spectral functions for defects using phonon interpolation](https://arxiv.org/abs/2607.20788)
...
### [37] [Photo-induced currents and short-term memory for reservoir computing in a ferroelectric semiconductor](https://arxiv.org/abs/2607.20810)
...
### [38] [MatDiffract: A Material-Informed Automated Analysis Platform for X-ray Powder Diffraction](https://arxiv.org/abs/2607.20880)
...
### [39] [Long- and Short-Range Anion Order in SrTiO$_{3-x}$H$_x$ Perovskite Oxyhydrides: DFT+$U$ Sensitivity and HSE06 Cluster Expansion](https://arxiv.org/abs/2607.20885)
...
### [40] [Orbital Hall Effect Enables Field-Free Magnetization Reversal in Ferrimagnets without Additional Conversion Layer](https://arxiv.org/abs/2607.20888)
...
### [41] [Visualizing Microwave-Driven Dynamics of Antiskyrmions and Surface Skyrmions](https://arxiv.org/abs/2607.20904)
...
### [42] [Complete Raman Tensor Determination in Birefringent $β$-Ga$_2$O$_3$ by Single-Stage Hyperspectral Analysis of Polarization Angle-Resolved Raman Spectra](https://arxiv.org/abs/2607.21045)
...
### [43] [Tunnel magnetoresistance effect with a Cr-doped $\mathrm{RuO_{2}}(110)$ altermagnet](https://arxiv.org/abs/2607.21092)
...
### [44] [Magneto-Caloric effect and Multiple magnetic phases in Al doped Ni2MnSn0.75Al0.25 Heusler Alloys](https://arxiv.org/abs/2607.21181)
...
### [45] [Machine learning based prediction of optical properties in two-dimensional Mo-W-S-Se-Te transition-metal dichalcogenide alloys through physics-informed sampling](https://arxiv.org/abs/2607.21246)
...
### [46] [Lifetime effects and satellites in the photoelectron spectrum of platinum metal](https://arxiv.org/abs/2607.21298)
...
### [47] [Geometric Superconducting Diode Effect in an NbN Nanoring](https://arxiv.org/abs/2607.20794)
...
### [48] [Evidence for fully-gapped superconductivity in BCS superconductor NiBi3](https://arxiv.org/abs/2607.20974)
...
### [49] [Magnetically memorable inductance in superconducting multilayer resonators](https://arxiv.org/abs/2607.21147)
...
### [50] [Puzzling superconductivity in strontium ruthenate: then and now](https://arxiv.org/abs/2607.21194)
...
### [51] [Supercurrent effect in a charge density wave intertwined superconductor](https://arxiv.org/abs/2607.21507)
...
### [52] [Sequential Topological Superconductivity in a Square Lattice with Chiral Charge Density Waves](https://arxiv.org/abs/2607.21525)
...
### [53] [An FBSDE Construction of the Sine-Gordon EQFT for $β^{2} < \frac{6}{7}\, 8π$ and Perturbative Renormalization in the Full Subcritical Regime](https://arxiv.org/abs/2607.20632)
*Sarah-Jean Meyer*
...
### [54] [Affine Extension of the Free-Particle--Oscillator--Inverted-Oscillator Triangle](https://arxiv.org/abs/2607.20711)
...
### [55] [High-resolution decomposition of canonical Hamiltonian systems](https://arxiv.org/abs/2607.20740)
...
### [56] [An Operator-Algebraic Exposition of the Thirring-Wehrl Theory of the Quasi-Spin BCS Model](https://arxiv.org/abs/2607.21158)
*Yoshitsugu Sekine*
...
### [57] [Continuum limit of discretized matrix-valued Fourier multipliers](https://arxiv.org/abs/2607.21177)
...
### [58] [Representation of the causal logic for the Dirac system and the electron](https://arxiv.org/abs/2607.21266)
...
### [59] [On Leray's Theoreme de Structure for a weak solution to the Navier-Stokes equations: an improvement of the result](https://arxiv.org/abs/2607.21380)
*Paolo Maremonti*
...
### [60] [Two-phase source and reaction coefficient Stefan type problems](https://arxiv.org/abs/2607.21388)
*Targyn A. Nauryz*
...
### [61] [Driven criticality links universal computation and optimal representations](https://arxiv.org/abs/2607.21232)
...
### [62] [Doping-induced Ferromagnetic order and its unusual evolution to Helical Antiferromagnetic Order in Sr(Ni$_{1-x}$Co$_x$)$_2$P$_2$](https://arxiv.org/abs/2607.20663)
...
### [63] [Thermal Hall Resistivity as a Unifying Description of Phonon Thermal Hall Effect in Various Insulators](https://arxiv.org/abs/2607.21157)
...
### [64] [Monte Carlo Studies of Twisted Bilayer Graphene: Strain and Thermal Fluctuations](https://arxiv.org/abs/2607.20619)
...
### [65] [Colloquium: Semi-Dirac Fermions in Quantum Matter](https://arxiv.org/abs/2607.20627)
...
### [66] [Ferromagnetic transition in a chiral spin chain](https://arxiv.org/abs/2607.20629)
...
### [67] [Exact Nagaoka-to-spiral transition in the doped infinite-U triangular lattice](https://arxiv.org/abs/2607.20726)
...
### [68] [Gaplessness indicator by topologically trivial twisting operators](https://arxiv.org/abs/2607.20944)
...
### [69] [Long-wavelength density response and momentum resolution in strange-metal charge spectroscopy](https://arxiv.org/abs/2607.21206)
*Ilmo Sung*
...
### [70] [Shiba duality and $η$-altermagnetism: Pairing and charge orders in bipartite attractive Hubbard models](https://arxiv.org/abs/2607.21430)
*Yu-Ping Lin*
...
### [71] [Interlayer interactions reshape charge-density wave through electronic elasticity in 4H$_{\mathrm{b}}$-TaS$_2$](https://arxiv.org/abs/2607.21470)
...
### [72] [Pseudogap formation in the moderate correlated layered attractive Hubbard model](https://arxiv.org/abs/2607.21478)
...
### [73] [Strong correlations and local self-energies from on-site ensembles](https://arxiv.org/abs/2607.21490)
...
### [74] [Symmetry and Quantum Geometry in Bloch Bands](https://arxiv.org/abs/2607.21581)
