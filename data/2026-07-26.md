...
### [6] [Thermal Hall Resistivity as a Unifying Description of Phonon Thermal Hall Effect in Various Insulators](https://arxiv.org/abs/2607.21157)
...
### [7] [Exact Nagaoka-to-spiral transition in the doped infinite-U triangular lattice](https://arxiv.org/abs/2607.20726)
...
### [9] [Gaplessness indicator by topologically trivial twisting operators](https://arxiv.org/abs/2607.20944)
...
### [15] [Uni-XAS: Alignment-Driven Bidirectional Multimodal Learning for X-ray Absorption Spectroscopy](https://arxiv.org/abs/2607.20906)
...
### [16] [Lithium-Projected Phonon Spectral Distributions as Robust Descriptors of Ionic Conductivity in Solid Electrolytes](https://arxiv.org/abs/2607.20591)
...
### [31] [An FBSDE Construction of the Sine-Gordon EQFT for $β^{2} < \frac{6}{7}\, 8π$ and Perturbative Renormalization in the Full Subcritical Regime](https://arxiv.org/abs/2607.20632)
*Sarah-Jean Meyer*
...
### [32] [Affine Extension of the Free-Particle--Oscillator--Inverted-Oscillator Triangle](https://arxiv.org/abs/2607.20711)
...
### [33] [High-resolution decomposition of canonical Hamiltonian systems](https://arxiv.org/abs/2607.20740)
...
### [34] [An Operator-Algebraic Exposition of the Thirring-Wehrl Theory of the Quasi-Spin BCS Model](https://arxiv.org/abs/2607.21158)
*Yoshitsugu Sekine*
...
### [35] [Continuum limit of discretized matrix-valued Fourier multipliers](https://arxiv.org/abs/2607.21177)
...
### [36] [Representation of the causal logic for the Dirac system and the electron](https://arxiv.org/abs/2607.21266)
...
### [37] [On Leray's Theoreme de Structure for a weak solution to the Navier-Stokes equations: an improvement of the result](https://arxiv.org/abs/2607.21380)
*Paolo Maremonti*
...
### [38] [Two-phase source and reaction coefficient Stefan type problems](https://arxiv.org/abs/2607.21388)
*Targyn A. Nauryz*
...
### [39] [Geometric Superconducting Diode Effect in an NbN Nanoring](https://arxiv.org/abs/2607.20794)
...
### [40] [Evidence for fully-gapped superconductivity in BCS superconductor NiBi3](https://arxiv.org/abs/2607.20974)
...
### [41] [Magnetically memorable inductance in superconducting multilayer resonators](https://arxiv.org/abs/2607.21147)
...
### [42] [Puzzling superconductivity in strontium ruthenate: then and now](https://arxiv.org/abs/2607.21194)
...
### [43] [Supercurrent effect in a charge density wave intertwined superconductor](https://arxiv.org/abs/2607.21507)
...
### [44] [Sequential Topological Superconductivity in a Square Lattice with Chiral Charge Density Waves](https://arxiv.org/abs/2607.21525)
...
### [45] [Entanglement asymmetry and quantum Mpemba effect for Kramers-Wannier duality](https://arxiv.org/abs/2607.21226)
...
### [46] [Thermal pseudo-transitions in a frustrated spin-pseudospin sawtooth chain](https://arxiv.org/abs/2607.21359)
...
### [47] [Free-volume origin of diverging direct correlations in hard crystals: insights from an exact one-dimensional model](https://arxiv.org/abs/2607.21379)
...
### [48] [Optimal feedback control under stepwise equilibration and partial observation](https://arxiv.org/abs/2607.21523)
...
### [49] [Tensor resonances in teleparallel Gauss-Bonnet branes](https://arxiv.org/abs/2607.20567)
...
### [50] [Moduli-Space Laplacians, Asymptotic Geometry, and the Emergent String Conjecture](https://arxiv.org/abs/2607.20603)
...
### [51] [Towards Generalized Dimers for GTPs: $\mathcal{N}=2$ Fractional Branes at Infinite Coupling](https://arxiv.org/abs/2607.20607)
...
### [52] [New Type IIB Poly-instanton Effects and Axion Quintessence](https://arxiv.org/abs/2607.20613)
...
### [53] [Sp(4,Z) actions on 3d U(1)^2 symmetric theories: Order-five duality and bilayer quantum Hall hierarchies](https://arxiv.org/abs/2607.20622)
...
### [54] [Uniqueness of null-local modular flow](https://arxiv.org/abs/2607.20678)
...
### [55] [Flavour current correlators and the non-Abelian hydrodynamic approximation: the charged sector](https://arxiv.org/abs/2607.20991)
...
### [56] [Flux Vacua Near the Boundary of Large Complex Structure](https://arxiv.org/abs/2607.20777)
...
### [57] [Quantum Mpemba effect in holography](https://arxiv.org/abs/2607.20899)
...
### [58] [Coherent states versus Glauber-Sudarshan States: Bootstrapping, Schwinger-Keldysh Contours and Lefschetz Thimbles](https://arxiv.org/abs/2607.20927)
...
### [59] [Boundary Completion of Vacuum Persistence Probability](https://arxiv.org/abs/2607.20936)
...
### [60] [3d-3d correspondence for knot complements with finite and large $N$](https://arxiv.org/abs/2607.21479)
*Hee-Joong Chung*
...
### [61] [Selecting Complex Extremal Surfaces with the Kontsevich--Segal--Witten Criterion](https://arxiv.org/abs/2607.21030)
*Wu-zhong Guo*
...
### [62] [Gauge-Theoretical Method in Solving Zero-curvature Equations III --Gauge Theoretical Method and the Bäcklund Transformations for Solitons--](https://arxiv.org/abs/2607.21052)
...
### [63] [One-point holographic correlator in the expanding universe](https://arxiv.org/abs/2607.21107)
...
### [64] [Carroll fermions of arbitrary spin](https://arxiv.org/abs/2607.21124)
...
### [65] [Energy-Energy Correlators at Strong Coupling](https://arxiv.org/abs/2607.21139)
...
### [66] [Defect entanglement entropy for superconformal RG Interfaces](https://arxiv.org/abs/2607.21270)
...
### [67] [Diagonally gauged anomaly-free 6D supergravities and their vacua](https://arxiv.org/abs/2607.21311)
...
### [68] [High-Order Pole-Skipping in Near-Extremal Holography](https://arxiv.org/abs/2607.21386)
...
### [69] [Wilson Towers as Local Bulk Fields](https://arxiv.org/abs/2607.21397)
...
### [70] [Relational path integral, effective actions and quantum frame covariance](https://arxiv.org/abs/2607.21463)
...
### [71] [A universal scaling function for giant graviton OPE coefficients](https://arxiv.org/abs/2607.21472)
...
### [72] [Aspects of Closed Matricial Worlds](https://arxiv.org/abs/2607.21509)
...
### [73] [Revealing the conformal symmetry of the discrete series scalars in dS${}_2$](https://arxiv.org/abs/2607.21514)
*Lukas W. Lindwasser*
...
### [74] [On the strong coupling limit of Yang-Mills matrix models](https://arxiv.org/abs/2607.21593)
