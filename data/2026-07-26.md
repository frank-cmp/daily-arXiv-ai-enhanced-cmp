...
### [9] [Entanglement asymmetry and quantum Mpemba effect for Kramers-Wannier duality](https://arxiv.org/abs/2607.21226)
...
### [10] [Thermal pseudo-transitions in a frustrated spin-pseudospin sawtooth chain](https://arxiv.org/abs/2607.21359)
...
### [11] [Free-volume origin of diverging direct correlations in hard crystals: insights from an exact one-dimensional model](https://arxiv.org/abs/2607.21379)
...
### [12] [Optimal feedback control under stepwise equilibration and partial observation](https://arxiv.org/abs/2607.21523)
...
### [13] [Lithium-Projected Phonon Spectral Distributions as Robust Descriptors of Ionic Conductivity in Solid Electrolytes](https://arxiv.org/abs/2607.20591)
...
### [14] [Uni-XAS: Alignment-Driven Bidirectional Multimodal Learning for X-ray Absorption Spectroscopy](https://arxiv.org/abs/2607.20906)
...
### [17] [Analytical Forces from the Bethe-Salpeter Equation for Large-Scale Excited-State Relaxation](https://arxiv.org/abs/2607.20728)
...
### [18] [First-principles calculation of electron-phonon spectral functions for defects using phonon interpolation](https://arxiv.org/abs/2607.20788)
...
### [19] [Photo-induced currents and short-term memory for reservoir computing in a ferroelectric semiconductor](https://arxiv.org/abs/2607.20810)
...
### [20] [MatDiffract: A Material-Informed Automated Analysis Platform for X-ray Powder Diffraction](https://arxiv.org/abs/2607.20880)
...
### [21] [Long- and Short-Range Anion Order in SrTiO$_{3-x}$H$_x$ Perovskite Oxyhydrides: DFT+$U$ Sensitivity and HSE06 Cluster Expansion](https://arxiv.org/abs/2607.20885)
...
### [22] [Orbital Hall Effect Enables Field-Free Magnetization Reversal in Ferrimagnets without Additional Conversion Layer](https://arxiv.org/abs/2607.20888)
...
### [23] [Visualizing Microwave-Driven Dynamics of Antiskyrmions and Surface Skyrmions](https://arxiv.org/abs/2607.20904)
...
### [27] [Machine learning based prediction of optical properties in two-dimensional Mo-W-S-Se-Te transition-metal dichalcogenide alloys through physics-informed sampling](https://arxiv.org/abs/2607.21246)
...
### [28] [Lifetime effects and satellites in the photoelectron spectrum of platinum metal](https://arxiv.org/abs/2607.21298)
...
### [29] [Geometric Superconducting Diode Effect in an NbN Nanoring](https://arxiv.org/abs/2607.20794)
...
### [30] [Evidence for fully-gapped superconductivity in BCS superconductor NiBi3](https://arxiv.org/abs/2607.20974)
...
### [31] [Magnetically memorable inductance in superconducting multilayer resonators](https://arxiv.org/abs/2607.21147)
...
### [32] [Puzzling superconductivity in strontium ruthenate: then and now](https://arxiv.org/abs/2607.21194)
...
### [33] [Supercurrent effect in a charge density wave intertwined superconductor](https://arxiv.org/abs/2607.21507)
...
### [34] [Sequential Topological Superconductivity in a Square Lattice with Chiral Charge Density Waves](https://arxiv.org/abs/2607.21525)
...
### [35] [Doping-induced Ferromagnetic order and its unusual evolution to Helical Antiferromagnetic Order in Sr(Ni$_{1-x}$Co$_x$)$_2$P$_2$](https://arxiv.org/abs/2607.20663)
...
### [36] [Monte Carlo Studies of Twisted Bilayer Graphene: Strain and Thermal Fluctuations](https://arxiv.org/abs/2607.20619)
...
### [37] [Gaplessness indicator by topologically trivial twisting operators](https://arxiv.org/abs/2607.20944)
...
### [38] [Thermal Hall Resistivity as a Unifying Description of Phonon Thermal Hall Effect in Various Insulators](https://arxiv.org/abs/2607.21157)
...
### [39] [Colloquium: Semi-Dirac Fermions in Quantum Matter](https://arxiv.org/abs/2607.20627)
...
### [40] [Ferromagnetic transition in a chiral spin chain](https://arxiv.org/abs/2607.20629)
...
### [41] [Exact Nagaoka-to-spiral transition in the doped infinite-U triangular lattice](https://arxiv.org/abs/2607.20726)
...
### [42] [Long-wavelength density response and momentum resolution in strange-metal charge spectroscopy](https://arxiv.org/abs/2607.21206)
*Ilmo Sung*
...
### [43] [Shiba duality and $η$-altermagnetism: Pairing and charge orders in bipartite attractive Hubbard models](https://arxiv.org/abs/2607.21430)
*Yu-Ping Lin*
...
### [48] [Tensor resonances in teleparallel Gauss-Bonnet branes](https://arxiv.org/abs/2607.20567)
...
### [49] [Moduli-Space Laplacians, Asymptotic Geometry, and the Emergent String Conjecture](https://arxiv.org/abs/2607.20603)
...
### [50] [Flavour current correlators and the non-Abelian hydrodynamic approximation: the charged sector](https://arxiv.org/abs/2607.20991)
...
### [55] [Flux Vacua Near the Boundary of Large Complex Structure](https://arxiv.org/abs/2607.20777)
...
### [56] [Quantum Mpemba effect in holography](https://arxiv.org/abs/2607.20899)
...
### [57] [Coherent states versus Glauber-Sudarshan States: Bootstrapping, Schwinger-Keldysh Contours and Lefschetz Thimbles](https://arxiv.org/abs/2607.20927)
...
### [58] [Boundary Completion of Vacuum Persistence Probability](https://arxiv.org/abs/2607.20936)
...
### [59] [3d-3d correspondence for knot complements with finite and large $N$](https://arxiv.org/abs/2607.21479)
*Hee-Joong Chung*
...
### [60] [Selecting Complex Extremal Surfaces with the Kontsevich--Segal--Witten Criterion](https://arxiv.org/abs/2607.21030)
*Wu-zhong Guo*
...
### [61] [Gauge-Theoretical Method in Solving Zero-curvature Equations III --Gauge Theoretical Method and the Bäcklund Transformations for Solitons--](https://arxiv.org/abs/2607.21052)
...
### [62] [One-point holographic correlator in the expanding universe](https://arxiv.org/abs/2607.21107)
...
### [63] [Carroll fermions of arbitrary spin](https://arxiv.org/abs/2607.21124)
...
### [64] [Energy-Energy Correlators at Strong Coupling](https://arxiv.org/abs/2607.21139)
...
### [65] [Defect entanglement entropy for superconformal RG Interfaces](https://arxiv.org/abs/2607.21270)
...
### [66] [Diagonally gauged anomaly-free 6D supergravities and their vacua](https://arxiv.org/abs/2607.21311)
...
### [67] [High-Order Pole-Skipping in Near-Extremal Holography](https://arxiv.org/abs/2607.21386)
...
### [68] [Wilson Towers as Local Bulk Fields](https://arxiv.org/abs/2607.21397)
...
### [69] [Relational path integral, effective actions and quantum frame covariance](https://arxiv.org/abs/2607.21463)
...
### [70] [A universal scaling function for giant graviton OPE coefficients](https://arxiv.org/abs/2607.21472)
...
### [71] [Aspects of Closed Matricial Worlds](https://arxiv.org/abs/2607.21509)
...
### [72] [Revealing the conformal symmetry of the discrete series scalars in dS${}_2$](https://arxiv.org/abs/2607.21514)
*Lukas W. Lindwasser*
...
### [73] [On the strong coupling limit of Yang-Mills matrix models](https://arxiv.org/abs/2607.21593)
...
### [74] [Driven criticality links universal computation and optimal representations](https://arxiv.org/abs/2607.21232)
